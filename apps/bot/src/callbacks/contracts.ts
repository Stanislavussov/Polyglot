...
export const callbackContracts = [
  ...
  },
  {
    ...
    restartSafety: "stateless-restorable",
    durableLookupKey: "dictionary id",
    dbSource: "vocabulary_dictionaries scoped by user id; the prompt is armed in the Postgres-backed session",
    expiryBehavior: "localized noResults if missing or not owned",
    maxExampleData: "dict:search:2147483647",
  },
  {
    family: "dictionary",
    prefix: "dict:search-clear",
    restartSafety: "stateless-restorable",
    durableLookupKey: "dictionary id",
    dbSource: "vocabulary_dictionaries plus vocabulary_entries scoped by user id",
    expiryBehavior: "re-render the unfiltered first page from DB",
    maxExampleData: "dict:search-clear:2147483647",
  },
  {
    family: "dictionary",
    prefix: "dict:sort",
    restartSafety: "stateless-restorable",
    durableLookupKey: "dictionary id and the sort order itself",
    dbSource: "vocabulary_dictionaries plus vocabulary_entries scoped by user id",
    expiryBehavior: "re-render the first page from DB in the requested order",
    maxExampleData: "dict:sort:2147483647:recent",
  },
  {
    family: "dictionary",
    prefix: "dict:close",
