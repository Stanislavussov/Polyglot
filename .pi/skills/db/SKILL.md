...
### VocabularyRepository (Task 39+40 — replaces WordRepository)
...
type CreateVocabularyInput = { original: string; sourceLangId: number; inputType: 'word' | 'phrase'; emoji: string; nativeMeaning?: string; translations: Array<{ targetLangId: number; text: string; transcription?: string; expressionType?: string; equivalentNote?: string; connotationWarning?: string; details: VocabTranslationDetails }> };
