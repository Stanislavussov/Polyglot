...
│   └── cs.json
└── __tests__/
    ├── i18n.test.ts           # 138 tests (t(), getSupportedLangs, isSupported, locale consistency, qualityUncertain, flashcard keys, dictionary browse keys)
