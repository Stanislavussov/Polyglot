...
│   └── cs.json
└── __tests__/
    ├── i18n.test.ts           # 98 tests (t(), getSupportedLangs, isSupported, locale consistency, qualityUncertain)
