...
│   └── cs.json
└── __tests__/
    ├── i18n.test.ts           # 67 tests (t(), getSupportedLangs, isSupported, locale consistency)
