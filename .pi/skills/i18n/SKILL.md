...
│   └── cs.json
└── __tests__/
    ├── i18n.test.ts           # 120 tests (t(), getSupportedLangs, isSupported, locale consistency, qualityUncertain, flashcard keys)
