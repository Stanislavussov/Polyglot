...
- Translate mode asks the user to choose the source language when short shared-script input remains ambiguous and dictionary lookup only matches English; these inputs must not silently fall through to English translation.
