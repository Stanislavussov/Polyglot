---
name: bot
description: Thin harness adapter for Telegram bot work: commands, scenes, middleware, callbacks, and renderers.
---
...
## Scope
- Work mainly in apps/bot/src/.
- Keep Telegram UI/application flow out of packages/core/.
- Use repositories and core services through existing composition patterns.
