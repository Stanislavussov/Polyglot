...
module.exports = {
  forbidden: [
    ...
    },
    {
      ...
      comment: "validation may import i18n but must not import translation, topics, context-enrichment, idiom-analysis, or language-detect",
      severity: "error",
    ...
    },
    {
      ...
      comment: "translation may import validation and i18n but must not import context-enrichment, topics, idiom-analysis, or language-detect",
      severity: "error",
    ...
    },
    {
      ...
      comment: "context-enrichment may import translation but must not import validation, topics, idiom-analysis, i18n, or language-detect",
      severity: "error",
