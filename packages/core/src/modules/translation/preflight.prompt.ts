...
- "confirm_typo_suggestion": input likely contains a typo. Options must include 1-3 typo_correction choices and one translate_as_written choice.
...
- Labels and explanation must be in the user interface language.
- For source_language options, set langCode to the candidate source language.
